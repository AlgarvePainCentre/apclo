...
{make_sel("-faq-panel")} {{
  ...
  transition: max-height 280ms ease, opacity 200ms ease, padding 200ms ease !important;
}}

{make_sel("-faq-panel")}[data-open='true'] {{
...
print("TreatmentFAQ.css fixed and generated.")