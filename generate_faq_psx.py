...
{make_sel("-faq-panel")} {{
  ...
  transition: grid-template-rows 280ms ease, opacity 200ms ease, padding 200ms ease !important;
...
print("TreatmentFAQ.css updated to match psx-accordion wireframe.")