...
const routeEntries = [
  ...
  { path: 'specialities/stroke-medicine/cognitive-autonomy', lazy: createLazyRouteModule(() => import('./pages/specialities/StrokeMedicine/CognitiveAutonomy/page')), preloadPath: '/specialities/stroke-medicine/cognitive-autonomy' },
