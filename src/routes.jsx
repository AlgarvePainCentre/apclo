...
const routeEntries = [
  ...
  { path: 'specialities-template-lumbar', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-lumbar')), preloadPath: '/specialities-template-lumbar' },
  ...
  { path: 'specialities/pain-medicine/head-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/head-pain' },
  { path: 'specialities/pain-medicine/cervical-spine-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/cervical-spine-pain' },
  { path: 'specialities/pain-medicine/lumbar-spine-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/lumbar-spine-pain' },
  { path: 'specialities/pain-medicine/shoulder-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/shoulder-pain' },
  { path: 'specialities/pain-medicine/hand-and-elbow-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/hand-and-elbow-pain' },
  { path: 'specialities/pain-medicine/hip-and-groin-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/hip-and-groin-pain' },
  { path: 'specialities/pain-medicine/knee-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/knee-pain' },
  { path: 'specialities/pain-medicine/thoracic-wall-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/thoracic-wall-pain' },
  { path: 'specialities/pain-medicine/abdominal-wall-pain', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/abdominal-wall-pain' },
  { path: 'specialities/pain-medicine/pelvic-and-gynaecological', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/pain-medicine/pelvic-and-gynaecological' },
  ...
  { path: 'specialities/stroke-medicine/rehabilitation', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/rehabilitation' },
  { path: 'specialities/stroke-medicine/clinical-and-secondary-prevention-of-stroke', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/clinical-and-secondary-prevention-of-stroke' },
  { path: 'specialities/stroke-medicine/feeding-autonomy', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/feeding-autonomy' },
  { path: 'specialities/stroke-medicine/speech-autonomy', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/speech-autonomy' },
  { path: 'specialities/stroke-medicine/cognitive-autonomy', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/cognitive-autonomy' },
  { path: 'specialities/stroke-medicine/post-stroke-depression-and-mood-disorders', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/post-stroke-depression-and-mood-disorders' },
  { path: 'specialities/stroke-medicine/medical-complications-post-stroke', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/medical-complications-post-stroke' },
  { path: 'specialities/stroke-medicine/post-stroke-spasticity', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/post-stroke-spasticity' },
  { path: 'specialities/stroke-medicine/complex-regional-pain-syndrome', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/complex-regional-pain-syndrome' },
  { path: 'specialities/stroke-medicine/postural-and-motor-control-autonomy', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/postural-and-motor-control-autonomy' },
  { path: 'specialities/stroke-medicine/community-reintegration', lazy: createLazyRouteModule(() => import('./pages/specialities/SpecialityTemplate/page-live')), preloadPath: '/specialities/stroke-medicine/community-reintegration' },
