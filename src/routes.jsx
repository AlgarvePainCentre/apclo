...
const routeEntries = [
  ...
  { path: 'treatments/minimally-invasive-treatments/cryoblation', lazy: createLazyRouteModule(() => import('./pages/treatments/MinimallyInvasiveTreatments/Cryoblation/page')), preloadPath: '/treatments/minimally-invasive-treatments/cryoblation' },
  ...
  { path: 'treatments/non-invasive-treatments/occupation-therapy', lazy: createLazyRouteModule(() => import('./pages/treatments/NonInvasiveTreatments/OccupationTherapy/page')), preloadPath: '/treatments/non-invasive-treatments/occupation-therapy' },
