      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-left">
            <h1 className="hero-title">Cervical spine pain</h1>
            <p className="hero-subtitle">
              Neck pain can cause stiffness, headaches and difficulty with everyday activities.
            </p>
          </div>
          <div className="hero-right">
            ...
            <button
              type="button"
              className="hero-cta"
              aria-label="Book an appointment for cervical spine pain"
