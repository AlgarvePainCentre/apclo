...
const InjuriesPage: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="hero-content">
          <div className="hero-left">
            ...
            <p className="hero-subtitle">
              From sprains to tendon tears, we help athletes return to activity safely.
            </p>
          </div>
          <div className="hero-right">
            ...
            <button
              type="button"
              className="hero-cta"
              aria-label="Book an appointment for sports injuries"
      ...
      <ConditionDetailPage title="Sports injuries" areaLabel="sports injuries" />
    </>
  );
};
