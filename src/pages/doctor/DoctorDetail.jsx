      ...
      <div className="doctor-detail-grid">
        <section className="doctor-detail-info" aria-label="Doctor details">
          <div className="doctor-detail-info-inner">
            ...
            {doctor.social && Object.values(doctor.social).some((url) => url && url !== '#') && (
              <div className="doctor-detail-section doctor-detail-section--connect">
                <h3>Connect</h3>
                <div className="doctor-detail-social">
                  {doctor.social.linkedin && doctor.social.linkedin !== '#' && (
                  ...
                  {doctor.social.twitter && doctor.social.twitter !== '#' && (
                  ...
                  {doctor.social.facebook && doctor.social.facebook !== '#' && (
                  ...
                  {doctor.social.instagram && doctor.social.instagram !== '#' && (
