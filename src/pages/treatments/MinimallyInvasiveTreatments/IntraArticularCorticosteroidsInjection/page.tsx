            ...
            <div className="iacsi-conditions-grid tms-conditions-grid" role="list" aria-label="Conditions treated with intra-articular corticosteroid injections">
              <article className="iacsi-condition-card tms-conditions-card" role="listitem" aria-labelledby="iacsi-condition-oa-title">
                ...
                <div className="iacsi-condition-media tms-conditions-media" aria-hidden="true">
                  <img className="iacsi-condition-image tms-conditions-image" src="/assets/images/interspinous-spacers-treatment/DSC06795-1.webp" alt="" loading="lazy" decoding="async" />
                </div>
              </article>
              ...
              <article className="iacsi-condition-card tms-conditions-card" role="listitem" aria-labelledby="iacsi-condition-ra-title">
                ...
                <div className="iacsi-condition-media tms-conditions-media" aria-hidden="true">
                  <img className="iacsi-condition-image tms-conditions-image" src="/assets/images/interspinous-spacers-treatment/DegenerativeDiscDisease.webp" alt="" loading="lazy" decoding="async" />
                </div>
              </article>
              ...
              <article className="iacsi-condition-card tms-conditions-card" role="listitem" aria-labelledby="iacsi-condition-gout-title">
                ...
                <div className="iacsi-condition-media tms-conditions-media" aria-hidden="true">
                  <img className="iacsi-condition-image tms-conditions-image" src="/assets/images/interspinous-spacers-treatment/Spondylolisthesis.webp" alt="" loading="lazy" decoding="async" />
                </div>
              </article>
              ...
              <article className="iacsi-condition-card tms-conditions-card" role="listitem" aria-labelledby="iacsi-condition-bursitis-title">
                ...
                <div className="iacsi-condition-media tms-conditions-media" aria-hidden="true">
                  <img className="iacsi-condition-image tms-conditions-image" src="/assets/images/interspinous-spacers-treatment/FacetJointSyndrome.webp" alt="" loading="lazy" decoding="async" />
                </div>
              </article>
            </div>
          </div>
