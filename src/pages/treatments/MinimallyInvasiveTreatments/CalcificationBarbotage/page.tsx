...
const CalcificationBarbotagePage: React.FC = () => {
  ...
  React.useEffect(() => {
    const pageTitle = 'Calcification barbotage in ${location} | Ultrasound‑guided tendon care';
    document.title = pageTitle;

    const description =
      'Discover ultrasound‑guided calcification barbotage in ${location} for shoulder or tendon pain. Break up calcium deposits and book a specialist assessment.';
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-left">
            <h1 className="hero-title">Calcification barbotage</h1>
          ...
          <div className="hero-right">
            ...
            <button
              type="button"
              className="hero-cta"
              aria-label="Book an appointment for calcification barbotage"
