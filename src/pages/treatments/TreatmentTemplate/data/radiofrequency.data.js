// Radiofrequency — reused from the live page (validated). `treats` is injected
// from the facts bridge by the renderer, so it is not listed here.
export const data = {
  slug: 'radiofrequency',
  ...
  stepsLead: 'A minimally invasive, image-guided procedure — usually completed in a single visit.',
  overview: [
